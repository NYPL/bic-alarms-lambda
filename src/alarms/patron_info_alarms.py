...
def run_patron_info_alarms(self):
    ...
    for date in (sierra_new_counts.keys() | redshift_new_counts.keys()):
        ...
        new_patron_sierra_redshift_discrepancy_alarm(self, sierra_count, redshift_count, date)
        new_patron_sierra_no_records_alarm(self, sierra_count, redshift_count, date)
    ...
    for date in (sierra_deleted_counts.keys() |
        ...
        deleted_patron_sierra_redshift_discrepancy_alarm(self, sierra_count, redshift_count, date)
