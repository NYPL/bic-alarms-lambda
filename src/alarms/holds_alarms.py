...
def run_holds_alarms(self):
    ...
    if self.run_added_tests:
        for table_name in ['hold_info', 'queued_holds']:
            ...
            holds_not_updated_alarm(self, redshift_count, redshift_table)
    ...
    invalid_hold_alarms(self, deleted_holds, modified_holds, null_holds)
...
def invalid_hold_alarms(self, deleted_holds, modified_holds, null_holds):
