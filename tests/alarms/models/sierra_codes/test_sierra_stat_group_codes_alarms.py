...
class TestSierraItypeCodesAlarms:
    ...
    def test_instance(self, mocker):
        ...
        return SierraStatGroupCodesAlarms(test_logger, mock_redshift_client, 
                               mock_sierra_client)
    ...
    def test_init(self, mocker):
       ...
       mock_redshift_client = mocker.MagicMock()
       mock_sierra_client = mocker.MagicMock()
       sierra_stat_group_codes_alarms = SierraStatGroupCodesAlarms(mock_logger, mock_redshift_client, 
                                           mock_sierra_client)
    ...
    def test_run_checks_unknown_locations_alarm(
            self, test_instance, mocker, caplog):
        mocker.patch(
            'alarms.models.sierra_codes.sierra_stat_group_codes_alarms.build_sierra_code_count_query')
        mocker.patch(
