...
class TestLocationVisitsAlarms:
    ...
    def test_instance(self, mocker):
        ...
        return LocationVisitsAlarms(test_logger, mock_redshift_client)
    
    def test_init(self, mocker):
       mock_redshift_client = mocker.MagicMock()
       mock_logger = mocker.MagicMock()
       location_visits_alarms = LocationVisitsAlarms(
           mock_logger, mock_redshift_client)
    ...
    def test_run_checks_duplicate_records_alarm(
            self, test_instance, mocker, caplog):
        mocker.patch(
            'alarms.models.location_visits_alarms.build_redshift_location_visits_count_query')
        mocker.patch(
    ...
    def test_run_checks_stale_records_alarm(
            self, test_instance, mocker, caplog):
        mocker.patch(
            'alarms.models.location_visits_alarms.build_redshift_location_visits_count_query')
        mocker.patch(
