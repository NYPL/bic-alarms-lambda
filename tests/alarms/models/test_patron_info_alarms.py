...
class TestPatronInfoAlarms:
    ...
    def test_instance(self, mocker):
        ...
        return PatronInfoAlarms(test_logger, mock_redshift_client, 
                                mock_sierra_client)
    ...
    def test_run_checks_unequal_counts_alarm(
        ...
        mocker.patch('alarms.models.patron_info_alarms.build_sierra_deleted_patrons_query')
        mocker.patch('alarms.models.patron_info_alarms.build_redshift_new_patrons_query')
        mocker.patch('alarms.models.patron_info_alarms.build_redshift_deleted_patrons_query')
    ...
    def test_run_checks_no_records_alarm(
            self, test_instance, mocker, caplog):
        mocker.patch('alarms.models.patron_info_alarms.build_sierra_new_patrons_query')
        mocker.patch('alarms.models.patron_info_alarms.build_sierra_deleted_patrons_query')
        mocker.patch('alarms.models.patron_info_alarms.build_redshift_new_patrons_query')
