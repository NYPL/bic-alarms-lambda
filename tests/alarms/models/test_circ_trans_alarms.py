...
class TestCircTransAlarms:
    ...
    def test_instance(self, mocker):
        ...
        return CircTransAlarms(test_logger, mock_redshift_client, 
                               mock_sierra_client)
    ...
    def test_init(self, mocker):
       ...
       mock_redshift_client = mocker.MagicMock()
       mock_sierra_client = mocker.MagicMock()
       circ_trans_alarms = CircTransAlarms(mock_logger, mock_redshift_client, 
                                           mock_sierra_client)
    ...
    def test_run_checks_unequal_counts(
            self, test_instance, mocker, caplog):
    ...
    def test_run_checks_no_records(
            self, test_instance, mocker, caplog):
        mocker.patch('alarms.models.circ_trans_alarms.build_sierra_circ_trans_query')
        mocker.patch('alarms.models.circ_trans_alarms.build_redshift_circ_trans_query')
