...
class TestPcReserveAlarms:
    ...
    def test_instance(self, mocker):
        ...
        return PcReserveAlarms(test_logger, mock_redshift_client, 
                               mock_envisionware_client)
    
    def test_init(self, mocker):
       mock_logger = mocker.MagicMock()
       mock_redshift_client = mocker.MagicMock()
       mock_envisionware_client = mocker.MagicMock()
       pc_reserve_alarms = PcReserveAlarms(mock_logger, mock_redshift_client, 
                                           mock_envisionware_client)
    ...
    def test_run_checks_unequal_counts_alarm(
            self, test_instance, mocker, caplog):
        mocker.patch('alarms.models.pc_reserve_alarms.build_envisionware_pc_reserve_query')
