def sierra_redshift_count_mismatch_alarm(
    logger, code_type, sierra_count, total_redshift_count
):
...
def redshift_duplicate_code_alarm(
    logger, code_type, total_redshift_count, distinct_redshift_count
):
